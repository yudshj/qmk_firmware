...
#    define CAPSENSE_DAC_NCS B5  //F6  //~SELECTDAC
#    define CAPSENSE_DAC_SCK B6   //SHCP // CLOCK
#    define CAPSENSE_DAC_SDI C6    //MOSI
#    define CAPSENSE_DAC_MAX 4095

#    define CAPSENSE_SHIFT_DIN  C6    //MOSI
#    define CAPSENSE_SHIFT_OE   F7
#    define CAPSENSE_SHIFT_SHCP B6       //SHCP  //CLOCK
#    define CAPSENSE_SHIFT_STCP C7   //F7   //LOADCOL
...
//D0-D7 or B0-B7
//#        define CAPSENSE_READ_ROWS_VALUE ((dest_row_2 & 0xff))
//#        define CAPSENSE_READ_ROWS_VALUE ((dest_row_3 & 0xff))
#          define CAPSENSE_READ_ROWS_VALUE ((dest_row_2  & 0x80) | ((dest_row_3 <<2 ) & 0x40) | ((dest_row_2 << 5) & 0x20) | ((dest_row_2 << 3 ) & 0x10) | (dest_row_2   & 0x08) | (dest_row_2  & 0x04) | ((dest_row_2 >> 3) & 0x02) | ((dest_row_2 >> 6) & 0x01))
